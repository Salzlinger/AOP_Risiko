...
class SpielerAnzahl extends JDialog {
	...
	private JPanel spielerAnzahlPanel()
	{
		...
		fuenfSpielerBtn = new JButton("F�nf");
...
class Spielbrett extends JDialog {
	...
	public Spielbrett() {
		  ...
		  Runnable r = () -> {
	            ...
	            System.out.println("Die Shapes entsprechen folgenden L�ndern: " + laenderShapes.values());
